...
print("Array 3:\n",array3,"Shape of array 3:",array3.shape);
print("Array 4:\n",array4,"Shape of array 4:",array4.shape);
print("-----------------------------------Concatenate axis=0----------------------------------------")
make_another_concatenate_at_axis_zero=np.concatenate((array3,array4),axis=0);
print("make_another_concatenate_at_axis_zero:\n",make_another_concatenate_at_axis_zero)
...
print("make_another_concatenate_at_axis_one:\n",make_another_concatenate_at_axis_one);
...
print("Original arr001:\n",arr001);
print("Original arr002:\n",arr002);
...
print("make_concatenate_arr001_and_arr002:\n",make_concatenate_arr001_and_arr002_axis_0);
...
print("make_concatenate_arr001_and_arr002:\n",make_concatenate_arr001_and_arr002_axis_1);
...
print("make_concatenate_arr001_and_arr002:\n",make_concatenate_arr001_and_arr002);
