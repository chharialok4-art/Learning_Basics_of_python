...
print("Stack One and Two Axis Zero:",make_stack_Axis_Zero);
print("--------------------------------Stack axis-1-------------------------------------------------")
make_stack_Axis_One=np.stack((array1,array2),axis=1);
print("Shape Stacked Array:",make_stack_Axis_One.shape);
print("Stack One and Two Axis One:",make_stack_Axis_One);
print("--------------------------------Stack axis-2-------------------------------------------------")
